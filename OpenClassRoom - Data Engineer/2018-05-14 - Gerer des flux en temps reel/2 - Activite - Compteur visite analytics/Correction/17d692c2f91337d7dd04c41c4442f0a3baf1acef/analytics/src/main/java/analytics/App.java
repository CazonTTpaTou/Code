...
public class App 
{
	public static void main( String[] args ) throws AlreadyAliveException, InvalidTopologyException, AuthorizationException
	{
		...
		// MODIFICATION CODE APP.JAVA POUR OPENCLASSROOM
		builder.setBolt("user-page-visit-counts", new UserPageVisitCount(), 2)
			.fieldsGrouping("page-visits", new Fields("url"));
		// FIN MODIFICATION CODE APP.JAVA POUR OPENCLASSROOM

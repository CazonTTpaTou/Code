...
p1 = multiprocessing.Process(target=count_capitals_in_emails, args=(0, 1986, capital_letters))

p2 = multiprocessing.Process(target=count_capitals_in_emails, args=(1986, 3972, capital_letters))

p3 = multiprocessing.Process(target=count_capitals_in_emails, args=(3972, 5959, capital_letters))

p4 = multiprocessing.Process(target=count_capitals_in_emails, args=(5959, 7946, capital_letters))
...
capital_letters1 = list()
capital_letters2 = list()
...
def count_capital_letters(mail):
    return len([letter for letter in mail if letter.isupper()])

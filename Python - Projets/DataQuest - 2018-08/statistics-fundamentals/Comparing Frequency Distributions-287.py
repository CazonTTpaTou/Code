...
plt.axvline(x=wnba['MIN'].mean(),label='Average')
...
lower_bound = 22 - iqr*factor
upper_bound = 29 + iqr*factor

outliers_low = wnba[wnba['Games Played']<lower_bound].count()

outliers_high = wnba[wnba['Games Played']>upper_bound].count()

...
new_order = sorted(original_index)

sorted_by_index = series_custom.reindex(new_order)
...
mean_score = (rt_critics + rt_users)/2

rt_mean =Series(mean_score,index=rt_users.index)

...
best_movies_ever_list = ["The Lazarus Effect (2015)","Gett: The Trial of Viviane Amsalem (2015)","Mr. Holmes (2015)"]

best_movies_ever = fandango_films.loc[best_movies_ever_list]
...
types = fandango_films.dtypes
float_df_type = types[types.values=='float'].index

float_df = fandango_films.loc[:,float_df_type]

...
class AgenceBancaire implements java.lang.Comparator<CompteBancaire>{
...
public int compare(CompteBancaire c1, CompteBancaire c2) {
      int nombre1 = ((CompteBancaire)c1).getNumero(); 
      int nombre2 = ((CompteBancaire)c2).getNumero();  

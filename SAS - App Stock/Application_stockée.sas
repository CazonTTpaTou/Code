...
*
*  ====================================================================
*  Nom de l'application stockée : DS_SQC.V_Lots
*
*  Description : Encapsulation du filtre de l'utilisateur dans une
*                application stockée afin d'éviter les multiples
*                anomalies de l'add-in Excel
*
*  Mots-clés : SAS.BI.Metadata.Model.Types.Keyword,
*              SAS.BI.Metadata.Model.Types.Keyword
*  ====================================================================
*;
...
**********************************************************;
* Program name      : DS_SQC.V_Lots
*
* Inputs            : Aucun
*
* Outputs           : Données pour le classeur BaseCellules.xlsm de CETIN Suleyman 
*
* Features	    : Encapsulation du filtre de l'utilisateur dans une application stockée afin d'éviter les multiples anomalies de l'add-in Excel 
*
* Updated by        : MONNERY FABIEN –  17/03/2014 
...
SELECT
	...
	Tri_Qte_L_20_0 AS Tri_Qte_L_20_0 LABEL = "Tri_Qte_L_20_0",
	Tri_Qte_L_19_8 AS Tri_Qte_L_19_8 LABEL = "Tri_Qte_L_19_8",
	Tri_Qte_L_19_6 AS Tri_Qte_L_19_6 LABEL = "Tri_Qte_L_19_6",
	Tri_Qte_L_19_4 AS Tri_Qte_L_19_4 LABEL = "Tri_Qte_L_19_4",
	Tri_Qte_L_19_2 AS Tri_Qte_L_19_2 LABEL = "Tri_Qte_L_19_2",
	Tri_Qte_L_19_0 AS Tri_Qte_L_19_0 LABEL = "Tri_Qte_L_19_0",
	Tri_Qte_L_16_4 AS Tri_Qte_L_16_ LABEL = "Tri_Qte_L_16_4",
    ...
    Seri_Vente_Qte AS Seri_Vente_Qte LABEL = "Seri_Vente_Qte"
		...
		FROM DS_SQC.V_LOTS
							WHERE 
								...
								AND 
								  DATEPART(Textu_Date_Heure_Sort) >= INTNX('month', DATE(), -4);

...
print(theta1)
print('Equation : y = {} x X + {}'.format(round(theta1[0],5),
                                          round(theta0),5))
...
# Menshgrid for parameters
theta0_,theta1_ = np.meshgrid(theta0s,theta1s)
print(theta0)
print(theta1)

for ind0 in range(100):
    for ind1 in range(100):
        COST[ind0,ind1]= cost(theta0_[0,ind0],
                              theta1_[ind1,0],
                              pga['distance'], 
                              pga['accuracy'])
...
def partial_cost_theta0(theta0, theta1, x, y):
    h= theta0 + theta1*x
    diff = (h - y)
    partial = diff.sum()/len(y)
    return partial

partial1 = partial_cost_theta1(0, 5, pga['distance'], pga['accuracy'])
print("partial1 =", partial1)

partial0 = partial_cost_theta0(1,
                               1,
                               pga['distance'],
                               pga['accuracy'])

print('partial2 =', partial0)    

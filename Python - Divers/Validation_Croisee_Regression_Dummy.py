...
class ValidationCroiseeRegressionDummy:
    
    def __init__(self,cheminFichier,nombreFold,hyperParametre,strategy):  
        ...
        self.modele = dummy.DummyRegressor(strategy=self.strategie)
    ...
    def entrainement_Modele(self,hyperParametres):
        ...
        self.erreur = []
        classification = dummy.DummyRegressor(strategy=self.strategie)
...
validation = ValidationCroiseeRegressionDummy(
                                        'E:\Data\RawData\ClassificationVin\winequality-red.csv',
                                         5,
                                         hyperparametres,
                                         'mean')

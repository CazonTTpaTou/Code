# Script d'export d'ensembles de termes au format CSV
# Téléchargé depuis internet : https://gallery.technet.microsoft.com/office/PowerShell-for-SharePoint-a838b5d0

# puis adapté pour une bonne prise en compte des accents
...
function Get-TermSetsCSV() {
 ...
 $CSVLine = New-TermLine -TermSetName $empty -TermSetDescription $empty -LCID 1036 -AvailableForTagging "TRUE" -TermDescription $empty -Level1 $tempTerms[0] -Level2 $tempTerms[1] -Level3 $tempTerms[2] -Level4 $tempTerms[3] -Level5 $tempTerms[4] -Level6 $tempTerms[5] -Level7 $tempTerms[6]

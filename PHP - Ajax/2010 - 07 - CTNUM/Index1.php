<?php 
	...
	if ((isset($connectID)) && ($connectID)) {
						 ...
						 header('location: Menu/Intro.php?Operation=0');
						}
	} ?>
...
<h1 class="title">CENTRE DE TRAITEMENT NUMERIQUE</h1>
<div class="encadrons">
...
<img  alt="image accueil" src="Logo CTN.jpg" />
</div>
...
En cas de perte de vos identifiants, veuillez contacter l'administrateur à l'adresse e-mail suivante: Webmaster@ctnum.fr
</marquee>

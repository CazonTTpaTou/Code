...
$req4="select C2.inac/c1.tot as attrition from (select count(*) as tot from clients where npai like '%actif%') as c1,";
$req4.="(select count(*) as inac from clients where npai not like '%actif%') as c2;";
...
$stat10=round($stat9/$stat2,2)*100;

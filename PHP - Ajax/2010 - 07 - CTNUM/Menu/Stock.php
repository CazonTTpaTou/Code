...
$value[0]=' ';
$value.=' ; ';
$rq="insert into stock_inter (com,prod,quant,flag) values ".$value;
//echo $rq;
$success=mysql_query($rq,$connectID) or die ("Impossible d'accéder aux données");
...
$sql.="inner join stock_inter as st on com.id_commande=st.com ";
$sql.="where id_commande in (select st.com from stock_inter as st group by st.com having sum(st.flag)>=0) ";

...
if (isset($_GET['id'])) {
   ...
   $sql="select * from ".$_SESSION['Tab']." where ".$ref."=".$_GET['id'].";";
	...
	while($ligne = mysql_fetch_array($resulte,MYSQL_ASSOC)) {
		...
		//----- On stocke les valeurs extraite de la ligne dans un tableau intitulé Contenu
...
//----- Lorsque l'on modifie une commande, on doit rajouter les lignes produit à la suite des champs commande

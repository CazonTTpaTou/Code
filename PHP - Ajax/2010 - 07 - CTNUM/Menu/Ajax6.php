...
if(($_POST['Client']!='inconnu')&&($_POST['Client']!='')) {$clause.="and id_client =".$_POST['Client']." ";}
if(($_POST['Commande']!='inconnu') && ($_POST['Commande']!='')) {
								 $clause.="and Montant".$op.$_POST['Commande']." ";}
if(($_POST['Date_d']!='inconnu')&&($_POST['Date_d']!=''))  {$clause.="and date>='".$_POST['Date_d']."' ";}
if(($_POST['Date_f']!='inconnu')&&($_POST['Date_f']!='')) {$clause.="and date<='".$_POST['Date_f']."' ";}

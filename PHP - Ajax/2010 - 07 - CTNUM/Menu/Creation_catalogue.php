...
print '<a href="Intro.php?Operation=51" >';
print '<input type="button" value="Modifier un catalogue" />';
print '</a>';
print '<a href="Intro.php?Operation=50" >';
print '<input type="button" value="Exporter un fichier XML" />';
print '</a>';
print'</span>';
print '<br/>';
print '<br/>';
...
print'<span class="libelle">';
print '<label>Date de début du catalogue :</label>';
print'</span>';
print'<br/>';
print'<span class="libelle">';
...
print '<label>Date de fin du catalogue :</label>';
print'</span>';
print'<br/>';
print'<span class="libelle">';

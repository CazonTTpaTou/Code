<?php 
	...
	if ((isset($connectID)) && ($connectID)) {session_start();
						 ...
						 //Détermination des droits de l'utilisateur identifié
						 include("Droits.php");
...
En cas de perte de vos identifiants, veuillez contacter l'administrateur à l'adresse e-mail suivante: Webmaster@tricastin.fr
</marquee>

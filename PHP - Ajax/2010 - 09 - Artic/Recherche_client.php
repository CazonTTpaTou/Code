...
if(($_SESSION['Operation']==3) || ($_GET['Operation']==3)) {$_SESSION['Lien']='Choisir';
			                                    $_SESSION['Adresse']='Intro.php?Operation=66&Client=';}
...
print '<input type="button" value="Création Nouvel Abonné" />';
print '</a>';
//print'</span>';
//print'<span class="champs">';
print '<a href="Intro.php?Operation=13" >';
print '<input type="button" value="Modifier Abonné" />';
print '</a>';
print'</span>';
print '<br/>';
print '<br/>';

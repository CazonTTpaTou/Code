...
print '<form onsubmit="return verif(this);" action="'.$_SERVER['PHP_SELF'].'?Operation=22&Livraison='.$_GET['Livraison'].'" method="POST">';
...
print'<input type="button" name="valid" value="Rajouter une ligne de livraison" onClick="Ajoute();" />';
print'</span>';
print '<br/>';
print '<br/>';
...
$req="select * from ligne_livraison where numero_com=".$_GET['Livraison']." ;";

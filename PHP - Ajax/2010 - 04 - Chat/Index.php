<?php 
 ...
 //-------Lorsque le formulaire de création de nouvel utilisateur a été validé, on effectue les vérifications
     if ((@$_POST['submitted2'])&&(isset($_GET['inscription']))) {
		
		if(nouveau(@$_POST['Nom'],@$_POST['MDP'],@$_POST['Ville'])==1) {print'OK';header('location: Cadres.php');}
...
//------ Si l'utilisateur est déjà inscrit, on affiche un formulaire simple de connexion
...
//------ Si l'utilisateur n'a pas encore de compte, on affiche un formulaire d'inscription

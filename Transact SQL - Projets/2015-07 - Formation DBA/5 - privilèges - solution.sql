...
-- base [DB_GRAND_HOTEL]
-- donnez le privilège de lire les tables du schema 
-- S_PUB à tout utilisateur présent et à venir

GRANT SELECT ON SCHEMA::S_PUB TO publlic

-- nouvelle base...
-- Créez une nouvelle base de nom DB_COMMON
-- et créez une table des codes postaux de la sorte :
...
GRANT SELECT ON dbo.T_CODE_POSTAL_CPL TO guest;

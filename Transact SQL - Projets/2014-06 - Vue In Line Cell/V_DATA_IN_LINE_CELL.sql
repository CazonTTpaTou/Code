...
/****** Object:  View [dbo].[V_DATA_IN_LINE_CELL]    Script Date: 06/16/2014 11:48:18 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[V_DATA_IN_LINE_CELL]
AS

SELECT

			 E01.DateTime AS [SINA_LOADER-DateTime]
			,E01.IdEquipement AS [SINA_LOADER-IdEquipement]
			,E01.Lane AS [SINA_LOADER-Lane]
			,E01.LotId AS [SINA_LOADER-LotId]
			,E01.LotWaferID AS [SINA_LOADER-LotWaferID]
			,E01.Reason AS [SINA_LOADER-Reason]
			,E01.TrayID AS [SINA_LOADER-TrayID]
			,E01.TraySlotID AS [SINA_LOADER-TraySlotID]
			...
			,E05.CarrierID AS [PRINT_LINE_LOADER-CarrierID]
			,E05.CarrierSlotID AS [PRINT_LINE_LOADER-CarrierSlotID]
			,E05.DateTime AS [PRINT_LINE_LOADER-DateTime]
			,E05.IdEquipement AS [PRINT_LINE_LOADER-IdEquipement]
			,E05.Lane AS [PRINT_LINE_LOADER-Lane]
			,E05.LotId AS [PRINT_LINE_LOADER-LotId]
			,E05.LotWaferID AS [PRINT_LINE_LOADER-LotWaferID]
			,E05.Reason AS [PRINT_LINE_LOADER-Reason]
			,E05.WaferEqID AS [PRINT_LINE_LOADER-WaferEqID]
		...
		FROM
			...
			dbo.WAFER_SNL AS E01
			
				LEFT OUTER JOIN dbo.WAFER_SNU AS E03
				ON E01.LotWaferID = E03.LotWaferID
				
				LEFT OUTER JOIN dbo.ICOS_BLUE_EYE AS E04
				ON E01.LotWaferID = E04.LotWaferID
				
				LEFT OUTER JOIN dbo.WAFER_PLL AS E05
				ON E01.LotWaferID = E05.LotWaferID
				
				LEFT OUTER JOIN dbo.WAFER_PP1 AS E06P1
				ON E01.LotWaferID = E06P1.LotWaferID
				
				LEFT OUTER JOIN dbo.WAFER_PP2 AS E06P2
				ON E01.LotWaferID = E06P2.LotWaferID
				
				LEFT OUTER JOIN dbo.WAFER_PN1 AS E06N1
				ON E01.LotWaferID = E06N1.LotWaferID
				
				LEFT OUTER JOIN dbo.ICOS_BSPI_P1 AS E07
				ON E01.LotWaferID = E07.LotWaferID
				
				LEFT OUTER JOIN dbo.ICOS_BSPI_P2 AS E08
				ON E01.LotWaferID = E08.LotWaferID
				
				LEFT OUTER JOIN dbo.ICOS_FSPI_N1 AS E09
				ON E01.LotWaferID = E09.LotWaferID
				
				LEFT OUTER JOIN dbo.DESPATCH_FIRING AS E10
				ON E01.LotWaferID = E10.LotWaferID
				
				LEFT OUTER JOIN dbo.WAFER_DES AS E11
				ON E01.LotWaferID = E11.LotWaferID
				
				LEFT OUTER JOIN dbo.BERGER_Results AS E12
				ON E01.LotWaferID = E12.WaferID
				
				LEFT OUTER JOIN dbo.ICOS_FSCC AS E14
				ON E01.LotWaferID = E14.LotWaferID
				
				LEFT OUTER JOIN dbo.ICOS_BSCC AS E15
